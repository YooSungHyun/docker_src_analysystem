...
public:
    ...
    NUMBER** getUbA();
    NUMBER** getUbB();
    // std::map<std::string, float> getPLMap();
    ...
    static void predict_nofile(NUMBER* metrics, const char *filename, NPAR* dat_obs, NCAT *dat_group, NCAT *dat_skill, NCAT *dat_skill_stacked, NCAT *dat_skill_rcount, NDAT *dat_skill_rix, HMMProblem **hmms, NPAR nhmms, NPAR *hmm_idx);
